...
from utilities.ns_solver_nonlinear import solve_nl_2d_navier_stokes_p_vectorized
...
if __name__ == '__main__':
    ...
    parameters_path = os.path.join(script_dir, "input", "parameters_ns.json")
    ...
    #u, v, p = solve_nl_2d_navier_stokes_p_vectorized(cfd_initsc, cfd_boundc, nx, ny, Lx, Ly, nu, nt, dt)
